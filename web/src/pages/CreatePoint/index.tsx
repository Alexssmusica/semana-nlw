...
const CreatePoint = () => {
    ...
    async function handleSubmit(evenet: FormEvent) {
        ...
        <div id="page-create-point">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset>
                    ...
                    <Map center={initialPosition} zoom={14.5} onClick={handleMapClick}>
                        <TileLayer
                    ...
                    <div className="field-group">
                        <div className="field">
                            ...
                            <select name="uf" id="uf" value={selectedUf} onChange={handleSelectdUf}>
                ...
                <fieldset>
                    ...
                    <ul className="items-grid">
                        {items.map((item) => (
                            <li
                                key={item.id}
                                onClick={() => handSelectedItem(item.id)}
